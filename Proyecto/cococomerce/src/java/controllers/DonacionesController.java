...
import jpa.entities.Donaciones;

@Named("donacionesController")
@SessionScoped
public class DonacionesController implements Serializable {

    private Donaciones current;
    private DataModel items = null;
    @EJB
    private facade.DonacionesFacade ejbFacade;
    ...
    public String prepareView() {
        current = (Donaciones) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("DonacionesCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("DonacionesUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("DonacionesDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public Donaciones getDonaciones(java.lang.Integer id) {
    ...
    public static class DonacionesControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Donaciones) {
                ...
                return getStringKey(o.getIdDonacion());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Donaciones.class.getName());
            }
        }
